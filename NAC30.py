...
def wincheck(gameboard, char, p):
    ...
    if gameboard[0] == char and gameboard[1] == char and gameboard[2] == char or gameboard[3] == char and gameboard[4] == char and gameboard[5] == char or gameboard[6] == char and gameboard[7] == char and gameboard[8] == char or gameboard[0] == char and gameboard[3] == char and gameboard[6] == char or gameboard[1] == char and gameboard[4] == char and gameboard[7] == char or gameboard[2] == char and gameboard[5] == char and gameboard[8] == char or gameboard[0] == char and gameboard[4] == char and gameboard[8] == char or gameboard[2] == char and gameboard[4] == char and gameboard[6] == char or ' ' not in gameboard: return True
printboard, gameboard = lambda gameboard: print("\n" + gameboard[0] + " # " + gameboard[1] + " # " + gameboard[2] + "\n" + "#########\n" + gameboard[3] + " # " + gameboard[4] + " # " + gameboard[5] + "\n" + "#########\n" + gameboard[6] + " # " + gameboard[7] + " # " + gameboard[8]), [' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ']
def move(gameboard, char, p, lonely, turn):
    print("\n" + p + ", choose a tile.")
    movemode, pmove = 'cpu' if lonely <= turn else 'hum', True
    while pmove == True:
        move = random.randint(0,8) if movemode == 'cpu' else int(input(">>> ")) -1
        if move > 8 or move < 0: print("Only numbers 1-9 are supported.")
        elif gameboard[move] == ' ': gameboard[move], pmove = char, False
def charchoose(p):
    while True:
...
while True:
    ...
    if lonely >= 0 and lonely <= 2: break
...
win, turn = False, random.randint(0,1)
while win != True:
